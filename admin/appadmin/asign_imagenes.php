...
$publicidad	=	sprintf("SELECT * FROM principal WHERE tipo_contenido in(21) AND eliminado=0 AND visible=1 %s ORDER BY fecha DESC",$filtro);
//echo $publicidad; 
//ejecuto y recorro
	...
	<form method="post">
		...
		<?foreach($datos_final as $banners){ ?>
			<tr>
				...
				<td align="center">
					<?
						echo "<a href='../../images/".$banners['imagen']."'  id='player".$banners['id']."' class='highslide' onclick='return hs.expand(this)'><img src='../../images/".$banners['imagen']."' width='60px' height='50px'>";
					?>
				</td>
