...
$tabla	 =	'<table align="center" width="100%" border="0" class="tablawidth nowitable" cellpadding="2" id="tabla" cellspacing="0">
					<tbody>
						<tr>
...
$tabla .= '</td>
				...
				$tabla	.='</td>
						...
						<tr class="center">';
							...
							elseif($tipo_contenido == 51)
							{
								$tabla.='<td align="center"><b>TIPO DE RESPUESTA</b></td>';
							}
							else
							{
							...
							else
							{
								...
								elseif($tipo_contenido == 51)//preguntas
								{
									$tabla.='<td align="center"><b>PREGUNTAS</b></td>';
								}
							...
							if($tipo_contenido == 17 or $tipo_contenido == 51 or $tipo_contenido == 54)//esto es para poner noticia en el home
							{
						...
						while($rew = $paging->fetchResultado())
						{
								...
								if($tipo_contenido == 17 or $tipo_contenido == 51 or $tipo_contenido == 54)//esto es para poner la noticia en el home
								{
									$tabla	.=	'<td align="center">';
					...
					$tabla	.=	'
									<tr>	
											...
											<td align="center">
												<input type="submit" value="Visible" name="activar">
											</td>';
					if($tipo_contenido == 17 or $tipo_contenido == 51 or $tipo_contenido == 54)//esto es para poner la noticia en el home
					{
						$tabla.='<td align="center"><input type="submit" value="Poner en Home" name="home"></td>';
					}
					...
					$tabla.='<input type="submit" value="Eliminar" name="eliminar">';	
					$tabla.='</td>
								</tr>
						</form>
						</tbody>
