...
<div id="form_carga">
	<form name="form1" action="upload.php" method="post" enctype="multipart/form-data">
		<table width="100%">
			<tr>
				<td colspan="2"><b>SUBIR UNA IMAGEN DIFERENTE</b></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Escriba un nuevo nombre para la imagen</td>
				<td>
			...
			<tr>
				<td>
					<input type="hidden" name="ruta" value="<?echo $ruta=(isset($_GET['dir']))?$_GET['dir']:'../diseno/images/';?>">
				</td>
			</tr>
		   	<tr>
				<td colspan="2"><b>CREACIÓN NUEVO FOLDER</b></td>
			</tr>
		</table>
	...
	{
		$ruta	=	(isset($_GET['dir']))?$_GET['dir']:'../diseno/images/';
						...
						<tr>							
							...
							<td>
								<div style='color:#ccc' valign='middle'>
									<img src='../diseno/cancel.png'> Error al crear la carpeta <b>".$nuevo_nombre.". </b>
								</div>
							</td>
						</tr>
						<tr>
